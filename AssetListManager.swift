...
//            }
            ...
            let asset = Asset(stream: Stream(name: "String", playlistURL: "https://d14nfbmksdrc0w.cloudfront.net/Disenchanted_2022_Official_Trailer/default.m3u8"), urlAsset: AVURLAsset(url: URL(string: "https://d14nfbmksdrc0w.cloudfront.net/Disenchanted_2022_Official_Trailer/default.m3u8")!))
            self.assets.append(asset)
